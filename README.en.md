...
> [v0.2.0](https://github.com/Halewwang/Simultaneous-interpretation/releases/tag/v0.2.0) is currently for internal evaluation only. The app and driver payloads are ad-hoc signed; the PKG itself is unsigned, not notarized by Apple, and is not a production public installer.

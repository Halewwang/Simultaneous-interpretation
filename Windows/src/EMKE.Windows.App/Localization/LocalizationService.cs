...
internal enum LocalizedString
{
    ...
    DiagnosticsClose,
    DiagnosticsConnectionStages,
    DiagnosticsDroppedFrames,
    DiagnosticsEndpointFormat,
    DiagnosticsEndpointIdentifier,
    DiagnosticsEndpointName,
    DiagnosticsEndpointRole,
    DiagnosticsEndpoints,
    DiagnosticsLastHResult,
    DiagnosticsOutcomeFailed,
    DiagnosticsOutcomeNotRun,
    DiagnosticsOutcomePassed,
    DiagnosticsOutcomeRequiresAudio,
    DiagnosticsOutcome,
    DiagnosticsOverflows,
    DiagnosticsRefresh,
    DiagnosticsRoleAppMicrophoneRender,
    DiagnosticsRoleAppSpeakerCapture,
    DiagnosticsRoleMeetingMicrophoneCapture,
    DiagnosticsRoleMeetingSpeakerRender,
    DiagnosticsRolePhysicalInput,
    DiagnosticsRolePhysicalOutput,
    DiagnosticsStage,
    DiagnosticsTestConnection,
    DiagnosticsTitle,
    DiagnosticsUnavailable,
    DiagnosticsUnderruns,
    LanguageEnglish,
    LanguageGerman,
    ...
    SettingsBaseUrl,
    SettingsDriverStatus,
    SettingsExportDiagnostics,
    SettingsFloatingStatus,
    SettingsFollowSystem,
    SettingsFollowDefaultInput,
    SettingsFollowDefaultOutput,
    SettingsInputDevice,
    SettingsInterfaceLanguage,
    SettingsLocalDiagnostics,
    SettingsMeetingLanguage,
    SettingsModel,
    SettingsOutputDevice,
    SettingsReopenOnboarding,
    SettingsSave,
    SettingsSavedResult,
    SettingsConnectionSucceededResult,
    SettingsStartRequestedResult,
    SettingsSaveFailedError,
    SettingsConnectionFailedError,
    SettingsStartFailedError,

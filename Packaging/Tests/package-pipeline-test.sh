...
PKG="$ROOT/.build/distribution/EMKE-Translation-0.2.2-internal.pkg"
...
/usr/bin/grep -Fq 'version="0.2.2"' "$TEMP/expanded/PackageInfo"
...
/usr/bin/grep -q \
  ...
  "$TEMP/payload-files"
test -L \
  "$TEMP/expanded/Payload/Applications/EMKE Translation.app/Contents/Frameworks/Sparkle.framework/Versions/Current"

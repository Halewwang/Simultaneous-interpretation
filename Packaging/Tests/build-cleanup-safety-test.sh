...
expect_rejected_without_mutation build-root-symlink "$BUILD_LINK_REPO" \
  ...
  "$BUILD_LINK_REPO/.build/distribution/EMKE-Translation-0.2.2-internal.pkg"
...
expect_rejected_without_mutation distribution-root-symlink "$DIST_LINK_REPO" \
  ...
  "$DIST_LINK_REPO/.build/distribution/EMKE-Translation-0.2.2-internal.pkg"
...
expect_rejected_without_mutation owned-child-symlink "$CHILD_LINK_REPO" \
  ...
  "$CHILD_LINK_REPO/.build/distribution/components" \
  "$CHILD_LINK_REPO/.build/distribution/EMKE-Translation-0.2.2-internal.pkg"
...
expect_rejected_without_mutation non-exact-target "$EXACT_REPO" \
  ...
  "$EXACT_REPO/.build/distribution/EMKE-Translation-0.2.2-internal.pkg"
...
bash "$VALIDATOR" "$SAFE_REPO" \
  ...
  "$SAFE_REPO/.build/distribution/EMKE-Translation-0.2.2-internal.pkg"
